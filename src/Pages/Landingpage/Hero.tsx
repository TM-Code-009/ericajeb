// Hero.tsx
// If you're using React Router, uncomment the following line:
...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full mt-20 bg-[#0d0d0d] text-white px-6 py-10 relative"
    >
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-gray-300 mb-6 max-w-md mx-auto lg:mx-0">
            I turn early-stage ideas into polished experiences—leveraging AI,
            design systems, and no-code tooling to help startups launch fast and
          ...
          <div className="flex justify-center lg:justify-start gap-4">
            ...
            <button className="flex items-center bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700 transition">
              <img
                src={icon}
                alt="Check Chat Icon"
                className="w-10 mt-1 h-10 object-contain"
              />
              Let's Connect
            </button>
            </a>
      ...
      <div className="hidden md:flex flex-col gap-3 fixed right-4 top-1/2 transform -translate-y-1/2 z-50">
        {[
          { label: "Home", id: "home" },
          { label: "Work", link: "/work" }, // Route to /work page
          { label: "Stacks", id: "stacks" },
          { label: "Clients", id: "clients" },
        ].map(({ label, id, link }) =>
          // Use this version if you're not using react-router:
          <a
            key={label}
            href={link || `#${id}`}
      ...
      <div className="max-w-6xl mx-auto mt-16 grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm">
        <div>
          ...
          <p className="mt-1">
            A systems-minded generalist who blends AI, design systems & no-code
            tools to ship fast
          </p>
        </div>
        <div>
